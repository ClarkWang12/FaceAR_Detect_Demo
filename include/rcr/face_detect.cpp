    ...
    else
    {
        ...
        if (detected_faces.empty())
        {
            ...
            else
            {
                ...
                Mat rm1(2, 3, CV_64F);
                rcr::getRotMat(cv::Point(image.cols/2,image.rows/2),angle,rm1);
