 ...
 */
rcr::LandmarkCollection<cv::Vec2f> to_landmark_collection(cv::Mat model_instance, std::vector<std::string> model_landmarks_list)
{
    rcr::LandmarkCollection<cv::Vec2f> collection;
